...
$ReadSettingsModule = DownloadHelperFile -url 'https://raw.githubusercontent.com/spetersenms/AL-Go/DeployToEnvVar/Actions/.Modules/ReadSettings.psm1' -folder $tmpFolder
$debugLoggingModule = DownloadHelperFile -url 'https://raw.githubusercontent.com/spetersenms/AL-Go/DeployToEnvVar/Actions/.Modules/DebugLogHelper.psm1' -folder $tmpFolder
